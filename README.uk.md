...
Цей проєкт розроблено для визначення вартості оренди в Бразилії. Інтерактивний інтерфейс створений на основі [**Streamlit**](https://streamlit.io/), що дозволяє легко взаємодіяти з моделлю та аналізувати результати.
...
- **hoa (0,052)**: Невеликий зв'язок із внесками в ОСББ. Це може впливати лише на певні типи житла (наприклад, квартири в ОСББ).
...
Міста, наприклад, city\*Belo Horizonte, city_Campinas:: У містах з негативною кореляцією з розміром орендної плати орендні ставки можуть бути нижчими порівняно з базовими містами (наприклад, city_São Paulo).
